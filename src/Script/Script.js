...
document.querySelectorAll(".readmoreServiceButton").forEach((button) => {
  button.addEventListener("click", function () {
    ...
    serviceBox.querySelector(".readlesserviceButton").style.display =
      "inline-block";
...
document.querySelectorAll(".readlesserviceButton").forEach((button) => {
  button.addEventListener("click", function () {
    ...
    serviceBox.querySelector(".readmoreServiceButton").style.display =
      "inline-block";
  });
});
  ...
  try {
    ...
    if (response.ok) {
      document.querySelector('.contact form').innerHTML = `
        <div class="thank-you-message" style="color: green;">
          <p>✅ Thank you! I will contact you within 48 business hours.</p>
        </div>`;
    } else {
